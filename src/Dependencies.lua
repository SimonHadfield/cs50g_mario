...
gTextures = {
    ...
    ['lock-keys'] = love.graphics.newImage('graphics/keys_and_locks.png'),
...
gFrames = {
    ...
    ['lock-keys'] = GenerateQuads(gTextures['lock-keys'], 16, 16),
    ['flag'] = GenerateQuads(gTextures['flag'], 16, 64),
    ['flagcloth'] = GenerateQuads(gTextures['flag'], 16, 16)
}
